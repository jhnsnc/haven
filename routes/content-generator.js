...
const grammar = tracery.createGrammar({
  ...
  'slide_topic_meditation_B_1': ['as thoughts #verb_surface#, #verb_permit# your mind to #verb_remain# #noun_serenity#'],
  'slide_topic_meditation_B_2': ['recognize each thought that comes to mind, and allow them to drift away freely'],
  ...
  'slide_grounding_3': ['before standing up and continuing your day #verb_take_time# in order to feel fully present and aware of your surroundings'],
  ...
  'verb_take_time': ['take plenty of time', 'spend as long as you need'],

  // nouns
  'noun_serenity': ['calm', 'focused'],
